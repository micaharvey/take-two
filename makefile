...
OBJS=takeTwo.o core/tt-audio.o core/tt-entity.o core/tt-gfx.o \
	core/tt-globals.o x-api/x-audio.o x-api/x-buffer.o x-api/x-fun.o \
...
takeTwo: $(OBJS)
	$(CXX) -o takeTwo $(OBJS) $(LIBS)

takeTwo.o: takeTwo.cpp
	$(CXX) -o takeTwo.o $(FLAGS) takeTwo.cpp

core/tt-audio.o: core/tt-audio.h core/tt-audio.cpp
	$(CXX) -o core/tt-audio.o $(FLAGS) core/tt-audio.cpp

core/tt-entity.o: core/tt-entity.h core/tt-entity.cpp
	$(CXX) -o core/tt-entity.o $(FLAGS) core/tt-entity.cpp

core/tt-gfx.o: core/tt-gfx.h core/tt-gfx.cpp
	$(CXX) -o core/tt-gfx.o $(FLAGS) core/tt-gfx.cpp

core/tt-globals.o: core/tt-globals.h core/tt-globals.cpp
	$(CXX) -o core/tt-globals.o $(FLAGS) core/tt-globals.cpp
